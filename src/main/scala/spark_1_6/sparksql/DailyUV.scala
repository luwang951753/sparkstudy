...
object DailyUV {
  ...
  case class Uv(date:String,count:Int)
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 这里着重说明一下！！！
    // TODO 要使用Spark SQL的内置函数，就必须在这里导入SQLContext下的隐式转换
    ...
    val userAccessLogRowDF: DataFrame = sqlContext.createDataFrame(userAccessLogRowRDD, structType)
