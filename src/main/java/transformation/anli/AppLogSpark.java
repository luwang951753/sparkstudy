...
import scala.Tuple2;
import transformation.anli.AccessLogInfo;
import transformation.anli.AccessLogSortKey;
...
public class AppLogSpark {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaRDD<String> accessLogRDD = sc.textFile(
				"D:\\idea\\project\\sparkstudy\\datas\\access.log");
